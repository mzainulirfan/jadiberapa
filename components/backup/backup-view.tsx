...
async function loadCurrentBundle(): Promise<StoreBackupBundle> {
  ...
  const [settings, categories, products, productVariants, customers, expenses, discounts, discountProducts, cashSessions, transactions, transactionItems, payments, stockMovements] = await Promise.all([
