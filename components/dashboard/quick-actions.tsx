...
import { ChevronRight, Grid, Refresh, X } from "@/components/ui/icons"
import {
    ...
    <section aria-label="Aksi Cepat">
      <div className="mb-2 flex items-center justify-between">
        <h2 className="flex items-center gap-1.5 text-sm font-semibold text-ink">
          <Grid className="size-4 text-ink-muted" />
          Aksi Cepat
        </h2>
        <button
          type="button"
      ...
      {actions.length === 0 ? (
        <p className="rounded-xl border border-hairline bg-canvas p-4 text-xs text-ink-faint">
        ...
        <div className="-mx-4 flex gap-2 overflow-x-auto px-4 pb-1">
          {actions.map((action) => {
            ...
            return (
              ...
              >
                <span className="flex size-12 items-center justify-center rounded-2xl border border-hairline bg-canvas text-ink">
