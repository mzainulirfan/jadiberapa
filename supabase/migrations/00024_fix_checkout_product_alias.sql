-- Hotfix idempoten untuk database yang sudah sempat menjalankan 00023.
-- pg_get_functiondef dapat mengembalikan keyword UPDATE dalam huruf kapital.
-- Jika alias tidak terpasang, referensi product.* menyebabkan missing FROM-clause.
